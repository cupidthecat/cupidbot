...
public class MouseSourceTest {
	...
	@Test
	public void virtualMouseClassHasNoCupidBotLiteralInConstantPool() throws IOException {
		List<String> hits = scanStringConstants(VirtualMouse.class);
		assertTrue("VirtualMouse.class must not LDC the literal \"CupidBot\" — that was the watermark we removed. Hits: " + hits,
				hits.isEmpty());
	}

	@Test
	public void mouseClassHasNoCupidBotLiteralInConstantPool() throws IOException {
		List<String> hits = scanStringConstants(Mouse.class);
		assertTrue("Mouse.class must not LDC the literal \"CupidBot\" — the sentinel watermark is retired. Hits: " + hits,
				hits.isEmpty());
	}
				...
				public MethodVisitor visitMethod(int access, String name, String descriptor, String signature, String[] exceptions) {
					return new MethodVisitor(Opcodes.ASM9) {
						...
						public void visitLdcInsn(Object value) {
							if (value instanceof String && "CupidBot".equals(value)) {
