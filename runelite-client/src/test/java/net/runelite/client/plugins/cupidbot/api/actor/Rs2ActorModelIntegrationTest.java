...
public class Rs2ActorModelIntegrationTest {
    ...
    public static void startClient() throws Exception {
        ...
        log.info("Waiting for CupidBot to fully initialize (clientThread injection)...");
    ...
    private static void performLoginWithWatchdog() throws Exception {
        for (int attempt = 1; attempt <= MAX_LOGIN_ATTEMPTS; attempt++) {
            ...
            boolean loggedIn = waitForConditionSafe("Login", 20, CupidBot::isLoggedIn);
            if (loggedIn) {
            ...
            if (attempt >= SCREENSHOT_ANALYZE_AFTER_ATTEMPT) {
                ...
                switch (analysis.action) {
                    ...
                    case WAIT:
                        ...
                        Thread.sleep(10000);
                        boolean loggedInAfterWait = waitForConditionSafe("Login after wait", 10, CupidBot::isLoggedIn);
    ...
    public void testAllVisiblePlayersGetWorldLocation() {
        ...
        retryUntilSuccess("visible players getWorldLocation()", () -> {
            List<Player> players = CupidBot.getClient().getPlayers();
    ...
    public void testAllVisibleNpcsGetWorldLocation() {
        ...
        retryUntilSuccess("visible NPCs getWorldLocation()", () -> {
            List<NPC> npcs = CupidBot.getClient().getNpcs();
