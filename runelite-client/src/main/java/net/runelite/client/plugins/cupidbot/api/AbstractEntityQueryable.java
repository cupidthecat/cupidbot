...
public abstract class AbstractEntityQueryable<
    ...
    public E firstOnClientThread() {
        return CupidBot.getClientThread().invoke(() -> first());
    }

    public E nearestOnClientThread() {
        return CupidBot.getClientThread().invoke(() -> nearest());
    }

    public E nearestOnClientThread(int maxDistance) {
        return CupidBot.getClientThread().invoke(() -> nearest(maxDistance));
    }

    public E nearestOnClientThread(WorldPoint anchor, int maxDistance) {
        return CupidBot.getClientThread().invoke(() -> nearest(anchor, maxDistance));
    }

    public List<E> toListOnClientThread() {
        return CupidBot.getClientThread().invoke(() -> toList());
    }
