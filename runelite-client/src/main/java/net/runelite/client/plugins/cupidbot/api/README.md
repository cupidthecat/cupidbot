...
Use the singleton caches exposed by `CupidBot`. Do not instantiate caches or queryables directly.

## Quick Start

```java
var banker = CupidBot.getRs2NpcCache().query()
    .withName("Banker")
