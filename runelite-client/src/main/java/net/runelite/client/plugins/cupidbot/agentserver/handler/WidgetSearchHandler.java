...
import net.runelite.client.plugins.cupidbot.util.widget.Rs2WidgetInspector;
import net.runelite.client.plugins.cupidbot.util.widget.Rs2WidgetInspector.WidgetDescription;
