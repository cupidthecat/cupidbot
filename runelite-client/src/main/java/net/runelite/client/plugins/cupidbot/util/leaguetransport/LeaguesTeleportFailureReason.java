...
public enum LeaguesTeleportFailureReason
{
	...
	/** Caller invoked {@link net.runelite.client.plugins.cupidbot.util.leaguetransport.Rs2LeaguesTransport#leaguesTeleport} on the RuneLite client thread (disallowed; blocks UI). */
