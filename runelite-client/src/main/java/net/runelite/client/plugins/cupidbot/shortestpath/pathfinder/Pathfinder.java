...
public class Pathfinder implements Runnable {
    /**
     * Detailed pathfinder traces — set logger {@code net.runelite.client.plugins.cupidbot.shortestpath.pathfinder}
     * to DEBUG, or use {@link CupidBot#log(org.slf4j.event.Level, String, Object...)} routing via CupidBot.
     */
    private static void pathfinderDiag(String format, Object... args) {
        CupidBot.log(Level.DEBUG, "[PathfinderDiag] " + format, args);
    }
