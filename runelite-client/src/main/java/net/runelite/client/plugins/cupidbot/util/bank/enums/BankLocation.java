package net.runelite.client.plugins.cupidbot.util.bank.enums;
...
public enum BankLocation {
    ...
    public boolean hasRequirements() {
        ...
        switch (this) {
            case CRAFTING_GUILD:
                boolean hasFaladorHardDiary = CupidBot.getVarbitValue(VarbitID.FALADOR_DIARY_HARD_COMPLETE) == 1;
            ...
            case COOKS_GUILD:
                boolean hasVarrockHardDiary = CupidBot.getVarbitValue(VarbitID.VARROCK_DIARY_HARD_COMPLETE) == 1;
            ...
            case CLAN_HALL:
                ...
                return CupidBot.getVarbitValue(933) > 1;
            case LLETYA:
            ...
            case FOSSIL_ISLAND:
                return Rs2Player.getQuestState(Quest.BONE_VOYAGE) == QuestState.FINISHED && CupidBot.getVarbitValue(VarbitID.FOSSIL_BANK) == 1;
            case VOLCANO_BANK:
            ...
            case LUMBRIDGE_FRONT:
                ...
                return CupidBot.getClient().getWorldType().contains(WorldType.PVP);
