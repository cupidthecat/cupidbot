...
public final class PluginStopHelper {
     ...
     * Accepts legacy enum names and display names from {@link CupidBotPluginChoice}.
     */
    public static String normalizeStoredValue(String rawValue, PluginManager pluginManager) {
        ...
        Optional<CupidBotPluginChoice> builtIn = CupidBotPluginChoice.fromConfigValue(rawValue);
    ...
    /**
     * Builds the combined list of built-in CupidBot plugins and installed external (Plugin Hub) plugins.
     */
    public static List<PluginStopOption> buildOptions(PluginManager pluginManager) {
        ...
        for (CupidBotPluginChoice choice : CupidBotPluginChoice.values()) {
            if (choice == CupidBotPluginChoice.NONE || choice.getClassName() == null) {
                continue;
            }
    ...
    public static String resolveDisplayName(String rawValue, PluginManager pluginManager) {
        ...
        if (isNone(normalized)) {
            return CupidBotPluginChoice.NONE.toString();
        }

        Optional<CupidBotPluginChoice> builtIn = CupidBotPluginChoice.fromConfigValue(normalized);
        if (builtIn.isPresent()) {
