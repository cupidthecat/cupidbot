...
public class Rs2WorldPoint {
    ...
    public static WorldPoint convertInstancedWorldPoint(WorldPoint worldPoint) {
        ...
        WorldPoint globalWorldPoint = WorldPoint.fromLocal(CupidBot.getClient(), l);
    ...
    public static WorldPoint toLocalInstance(WorldPoint worldPoint) {
        ...
        return WorldPoint.toLocalInstance(CupidBot.getClient().getTopLevelWorldView(),worldPoint).stream().findFirst().orElse(null);
    }
