package net.runelite.client.plugins.cupidbot.util.huntkit;
 ...
 * <p>
 * With the CupidBot parent plugin enabled, {@link net.runelite.client.plugins.cupidbot.CupidBotPlugin#onItemContainerChanged}
...
public final class Rs2HuntKit
{
	...
	public static void updateLocalKit(ItemContainerChanged event)
	{
		...
		{
			CupidBot.getClientThread().invokeLater(Rs2HuntKit::rebuildKitFromCurrentClient);
			return;
		}
	...
	{
		if (kitItems.isEmpty() && CupidBot.isLoggedIn())
		{
