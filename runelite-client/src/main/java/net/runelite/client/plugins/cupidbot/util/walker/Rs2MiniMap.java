...
public class Rs2MiniMap {
    ...
    public static Point localToMinimap(LocalPoint localPoint) {
        ...
        return CupidBot.getClientThread().runOnClientThreadOptional(() -> Perspective.localToMinimap(CupidBot.getClient(), localPoint))
                .orElse(null);
    }
    ...
    public static Point worldToMinimap(WorldPoint worldPoint) {
        ...
        return CupidBot.getClientThread().runOnClientThreadOptional(() -> Perspective.localToMinimap(CupidBot.getClient(), lp))
                .orElse(null);
    }
    ...
    public static Widget getMinimapDrawWidget() {
        if (CupidBot.getClient().isResized()) {
            if (CupidBot.getVarbitValue(Varbits.SIDE_PANELS) == 1) {
	...
	public static Shape getMinimapClipArea(double scale) {
		...
		boolean isResized = CupidBot.getClient().isResized();

		BufferedImage minimapSprite = CupidBot.getClientThread().runOnClientThreadOptional(() ->
			CupidBot.getSpriteManager().getSprite(
	...
	public static Shape getMinimapClipArea() {
		return getMinimapClipArea(CupidBot.getClient().isResized() ? 0.94 : 1.0);
	}
