package net.runelite.client.plugins.cupidbot.api.npc;
 ...
 *
 * IMPORTANT: Always use CupidBot.getRs2NpcCache().query() to create queries.
 * Never instantiate Rs2NpcQueryable directly.
 *
 * - Rs2NpcCache: Singleton cache accessed via CupidBot.getRs2NpcCache()
 * - query(): Returns a fluent queryable interface for filtering NPCs
 */
public class NpcApiExample {

    public static void examples() {
        Rs2NpcCache cache = CupidBot.getRs2NpcCache();
