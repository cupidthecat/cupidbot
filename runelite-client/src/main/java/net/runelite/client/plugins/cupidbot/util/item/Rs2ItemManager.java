...
public class Rs2ItemManager {
    ...
    /**
     * Gets item ID by name  consider add it to CupidBot's Rs2ItemManager.
    ...
    public static int getItemIdByName(String itemName, boolean fuzzy) {
        ...
        try {
            ...
            try {
                var searchResults = CupidBot.getItemManager().search(itemName.trim());
    ...
    public List<ItemPrice> searchItem(String query) {
        ...
        return CupidBot.getClientThread().runOnClientThreadOptional(() -> CupidBot.getItemManager().search(query)).orElse(Collections.emptyList());
    }
    ...
    public ItemComposition getItemComposition(int itemId) {
        return CupidBot.getClientThread().runOnClientThreadOptional(() -> CupidBot.getItemManager().getItemComposition(itemId)).orElse(null);
    }
