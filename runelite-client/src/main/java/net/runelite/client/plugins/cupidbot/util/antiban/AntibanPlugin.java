...
import net.runelite.client.plugins.cupidbot.util.antiban.enums.CombatSkills;
import net.runelite.client.plugins.cupidbot.util.antiban.ui.MasterPanel;
...
@PluginDescriptor(
        ...
        description = "Antiban for cupidbot",
        tags = {"main", "cupidbot", "antiban parent"},
        alwaysOn = true,
        hidden = true
)
@Slf4j
public class AntibanPlugin extends Plugin {
    ...
    private void handleMicroBreakIntegration() {
        ...
        if (CupidBot.isPluginEnabled(BreakHandlerPlugin.class)) {
        ...
        CupidBot.showMessage("Micro breaks need BreakHandler. Enable it to use micro breaks.");
    ...
    private void updateAntibanSettings(Skill skill) {
        ...
        if (activity != null && Rs2AntibanSettings.dynamicActivity) {
            ...
            if (Rs2AntibanSettings.devDebug) {
                CupidBot.log("Activity changed, new activity: " + activity);
            }
        ...
        if (activityIntensity != null && Rs2AntibanSettings.dynamicIntensity) {
            ...
            if (Rs2AntibanSettings.devDebug) {
                CupidBot.log("Activity changed, new activity intensity: " + activityIntensity);
            }
        }
    }
