package net.runelite.client.plugins.cupidbot.util.farming;

import lombok.extern.slf4j.Slf4j;
import net.runelite.api.Skill;
import net.runelite.api.coords.WorldPoint;
import net.runelite.client.plugins.cupidbot.CupidBot;
import net.runelite.client.plugins.cupidbot.questhelper.helpers.mischelpers.farmruns.CropState;
import net.runelite.client.plugins.cupidbot.questhelper.helpers.mischelpers.farmruns.FarmingHandler;
import net.runelite.client.plugins.cupidbot.questhelper.helpers.mischelpers.farmruns.FarmingPatch;
import net.runelite.client.plugins.cupidbot.questhelper.helpers.mischelpers.farmruns.FarmingWorld;
import net.runelite.client.plugins.cupidbot.questhelper.helpers.mischelpers.farmruns.PatchImplementation;
 ...
 * Provides comprehensive farming functionality for the CupidBot framework
 */
@Slf4j
@Singleton
public class Rs2Farming {
    ...
    private static FarmingWorld getFarmingWorld() {
        if (farmingWorld == null) {
            try {
                farmingWorld = CupidBot.getInjector().getInstance(FarmingWorld.class);
    ...
    private static void ensureFarmingHandlerInitialized() {
        if (farmingHandler == null) {
            farmingHandler = new FarmingHandler(CupidBot.getClient(), CupidBot.getConfigManager());
