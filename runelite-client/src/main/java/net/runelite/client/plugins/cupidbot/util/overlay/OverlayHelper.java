package net.runelite.client.plugins.cupidbot.util.overlay;
...
public class OverlayHelper {
    ...
    public void drawTile(Graphics2D graphics, LocalPoint localPoint, Font font, String text, Color color) {
        ...
        Polygon poly = Perspective.getCanvasTilePoly(CupidBot.getClient(), localPoint);
        ...
        Point canvasPoint = Perspective.getCanvasTextLocation(CupidBot.getClient(), graphics, localPoint, text, 0);
        if (canvasPoint != null) {
