...
public class WidgetInvokeHandler extends AgentHandler {
	...
	protected void handleRequest(HttpExchange exchange) throws IOException {
		...
		java.awt.Rectangle bounds = CupidBot.getClientThread().runOnClientThreadOptional(() -> {
			Widget w = CupidBot.getClient().getWidget(packedId);
		...
		CupidBot.doInvoke(menuEntry, clickRect);
