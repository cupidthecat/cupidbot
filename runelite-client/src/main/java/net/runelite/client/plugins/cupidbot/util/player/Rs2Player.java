...
public class Rs2Player {
    ...
    public static boolean hasPrayerRegenerationActive() {
        return (CupidBot.getVarbitValue(VarbitID.PRAYER_REGENERATION_POTION_TIMER) > 0);
    }
    ...
    public static void handleAnimationChanged(AnimationChanged event) {
        ...
        if (player != CupidBot.getClient().getLocalPlayer()) {
            return;
        }
    ...
    public static boolean waitForXpDrop(Skill skill, int time, boolean inventoryFullCheck) {
        final int skillExp = CupidBot.getClient().getSkillExperience(skill);
        return sleepUntilTrue(() ->
                        skillExp != CupidBot.getClient().getSkillExperience(skill) ||
    ...
    public static boolean isMoving(Rs2PlayerModel playerModel) {
        ...
        return CupidBot.getClientThread().runOnClientThreadOptional(() -> playerModel.getPoseAnimation() != playerModel.getIdlePoseAnimation()).orElse(false);
    }
    ...
    public static boolean isInteracting() {
        if (CupidBot.getClient().getLocalPlayer() == null) {
            return false;
        }
        return Optional.of(CupidBot.getClient().getLocalPlayer().isInteracting()).orElse(false);
    }
    ...
    public static boolean isMember() {
        return CupidBot.getVarbitPlayerValue(VarPlayerID.ACCOUNT_CREDIT) > 0;
    }
    ...
    public static boolean isInMemberWorld() {
        ...
        if (worldResult != null) {
            ...
            return worlds.stream()
                    .anyMatch(x -> x.getId() == CupidBot.getClient().getWorld() && x.getTypes().contains(WorldType.MEMBERS));
        }
    ...
    public static void logout() {
        ...
        if (currentWorldWidget != null) {
            ...
            CupidBot.doInvoke(new NewMenuEntry()
                    ...
                    .identifier(1)
                    .itemId(-1)
                    .option("Logout"), new Rectangle(1, 1, CupidBot.getClient().getCanvasWidth(), CupidBot.getClient().getCanvasHeight()));
        } else {
        ...
        if (time > 0 && players.size() >= amountOfPlayers) {
            ...
            for (Rs2PlayerModel player : players) {
                ...
                if (currentTime - detectionTime >= time) {
                    ...
                    CupidBot.hopToWorld(randomWorld);
                    return true;
                }
            }
    ...
    public static boolean useFood() {
        ...
        boolean inWilderness = CupidBot.getVarbitValue(Varbits.IN_WILDERNESS) == 1;
    ...
    public static Stream<Rs2PlayerModel> getPlayers(Predicate<Rs2PlayerModel> predicate, boolean includeLocalPlayer) {
        List<Rs2PlayerModel> players = Optional.of(CupidBot.getClient().getTopLevelWorldView().players()
                        .stream()
                        .filter(Objects::nonNull)
                        .map(Rs2PlayerModel::new)
                        .filter(x -> includeLocalPlayer || x.getPlayer() != CupidBot.getClient().getLocalPlayer())
                        .filter(predicate)
                        .collect(Collectors.toList())
    ...
    public static Map<KitType, String> getPlayerEquipmentNames(Rs2PlayerModel rs2Player) {
        Map<KitType, String> equipmentMap = CupidBot.getClientThread().runOnClientThreadOptional(() -> {
            Map<KitType, String> tempMap = new HashMap<>();
            for (KitType kitType : KitType.values()) {
                String itemName = CupidBot.getItemManager()
    ...
    public static int getCombatLevel() {
        return CupidBot.getClientThread().runOnClientThreadOptional(() ->
                CupidBot.getClient().getLocalPlayer().getCombatLevel()
        ).orElse(0);
    }
    ...
    public static Rs2PlayerModel getLocalPlayer() {
        return getPlayers(player -> player.getId() == CupidBot.getClient().getLocalPlayer().getId(), true).findFirst().orElse(null);
    }
	...
	public static WorldPoint getWorldLocation_Internal(){
		return CupidBot.getClientThread().runOnClientThreadOptional(() -> {
			...
			if (worldView == null || worldLocation == null) {
				return null;
			}
	...
	public static WorldPoint getWorldLocation() {
		return CupidBot.getRs2PlayerStateCache().getLocalPlayerPosition();
	}
	...
	public static WorldView getWorldView() {
		return CupidBot.getRs2PlayerStateCache().getLocalPlayerWorldView();
	}
    ...
    public static LocalPoint getLocalLocation() {
        return CupidBot.getClient().getLocalPlayer().getLocalLocation();
    }
    ...
    public static boolean isInMulti() {
        return CupidBot.getVarbitValue(VarbitID.MULTIWAY_INDICATOR)
                == 1;
    }
    ...
    public static boolean isInPoh() {
        return CupidBot.getClient().getTopLevelWorldView().getScene().isInstance()
                && CupidBot.getVarbitValue(VarbitID.POH_HOUSE_LOCATION) > 0;
    }
    ...
    public static boolean drinkPrayerPotionAt(int prayerPoints) {
        ...
        boolean inWilderness = CupidBot.getVarbitValue(Varbits.IN_WILDERNESS) == 1;
        boolean isInPVPWorld = CupidBot.getClient().getWorldType().contains(WorldType.PVP);
    ...
    public static int getAnimation() {
        return CupidBot.getClientThread().runOnClientThreadOptional(() -> {
            if (CupidBot.getClient() == null || CupidBot.getClient().getLocalPlayer() == null) return -1;
            return CupidBot.getClient().getLocalPlayer().getAnimation();
        }).orElse(-1);
    }
    ...
    public static QuestState getQuestState(Quest quest) {
        return CupidBot.getRs2PlayerStateCache().getQuestState(quest);
    }
    ...
    public static int getRealSkillLevel(Skill skill) {
        return CupidBot.getClientThread().runOnClientThreadOptional(() ->
                CupidBot.getClient().getRealSkillLevel(skill)
        ).orElse(0);
    }
    ...
    public static int getBoostedSkillLevel(Skill skill) {
        return CupidBot.getClientThread().runOnClientThreadOptional(() ->
                CupidBot.getClient().getBoostedSkillLevel(skill)
        ).orElse(0);
    }
    ...
    public static boolean isIronman() {
        int accountType = CupidBot.getVarbitValue(Varbits.ACCOUNT_TYPE);
    ...
    public static int getWorld() {
        return CupidBot.getClient().getWorld();
    }
    ...
    public static boolean checkIdleLogout(long randomDelay) {
        long idleClientTicks = Long.min(
                CupidBot.getClient().getMouseIdleTicks(),
                CupidBot.getClient().getKeyboardIdleTicks()
        );

        return idleClientTicks >= CupidBot.getClient().getIdleTimeout() - randomDelay;
    }
    ...
    public static boolean isInCave() {
        return Rs2Player.getWorldLocation().getY() >= 6400
                && !CupidBot.getClient().getTopLevelWorldView().isInstance();
    }
    ...
    public static int getRunEnergy() {
        return CupidBot.getClientThread().runOnClientThreadOptional(() -> CupidBot.getClient().getEnergy()).orElse(0) / 100;
    }
    ...
    public static boolean hasStaminaActive() {
        return CupidBot.getVarbitValue(Varbits.RUN_SLOWED_DEPLETION_ACTIVE) != 0;
    }
    ...
    public static int getGraphicId() {
        return CupidBot.getClient().getLocalPlayer().getGraphic();
    }
    ...
    public static boolean hasSpotAnimation(int graphicId) {
        return CupidBot.getClient().getLocalPlayer().hasSpotAnim(graphicId);
    }
    ...
    private static boolean invokeMenu(Rs2PlayerModel rs2Player, String action) {
        ...
        CupidBot.status = action + " " + rs2Player.getName();
    ...
    public static Actor getInteracting() {
        Optional<Actor> result = CupidBot.getClientThread().runOnClientThreadOptional(() -> {
            if (CupidBot.getClient().getLocalPlayer() == null) return null;

            var interactingActor = CupidBot.getClient().getLocalPlayer().getInteracting();
    ...
    public static boolean hasCompletedTutorialIsland() {
        return CupidBot.getVarbitPlayerValue(281) >= 1000;
    }
}
