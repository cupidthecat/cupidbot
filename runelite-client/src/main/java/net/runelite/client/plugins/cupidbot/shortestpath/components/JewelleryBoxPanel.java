...
public class JewelleryBoxPanel extends JPanel {
    ...
    public void loadJewelleryBox() {
        try {
            JewelleryBoxType loadedBox = CupidBot.getConfigManager().getConfiguration(CONFIG_GROUP, JEWELLERY_BOX, JewelleryBoxType.class);
            jewelleryBoxCmb.setSelectedItem(loadedBox);
        } catch (NullPointerException e) {
            CupidBot.log("Failed to load jewellery box config");
    ...
    private void saveJewelleryBoxToConfig() {
        ...
        CupidBot.getConfigManager().setConfiguration(CONFIG_GROUP, JEWELLERY_BOX, config);
    }
