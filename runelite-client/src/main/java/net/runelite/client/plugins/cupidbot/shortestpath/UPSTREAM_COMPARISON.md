# Shortest Path: Upstream vs CupidBot Comparison

Comparison of [Skretzo/shortest-path](https://github.com/Skretzo/shortest-path) (upstream) against the CupidBot fork.
...
## CupidBot-Specific Additions (Not in Upstream)
