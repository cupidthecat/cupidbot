package net.runelite.client.plugins.cupidbot.util.tileobject;
...
public class Rs2TileObjectModel implements TileObject {
    ...
    public String getName() {
        return CupidBot.getClientThread().invoke(() -> {
            ObjectComposition composition = CupidBot.getClient().getObjectDefinition(tileObject.getId());
    ...
    public boolean click(String action) {
        ...
        net.runelite.api.coords.LocalPoint playerLocal = CupidBot.getClient().getLocalPlayer() != null
        ...
        if (tooFar) {
            CupidBot.log("Object with id " + getId() + " is not close enough to interact with. Walking to the object....");
        ...
        try {
            ...
            CupidBot.status = action + " " + getName();
            ...
            if (index == -1) {
                CupidBot.log("Failed to interact with object " + getId() + " " + action);
            }
