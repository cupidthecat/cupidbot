package net.runelite.client.plugins.cupidbot.util.grandexchange.models;

import lombok.Getter;
import net.runelite.api.GrandExchangeOfferState;
import net.runelite.client.plugins.cupidbot.CupidBot;
import net.runelite.client.plugins.cupidbot.util.grandexchange.GrandExchangeSlots;
...
public class GrandExchangeOfferDetails {
    ...
    public String getItemName() {
        return CupidBot.getRs2ItemManager().getItemComposition(itemId).getName();
    }
