package net.runelite.client.plugins.cupidbot.shortestpath.pathfinder.policy;
...
public final class TransportRequirementPolicy {
    ...
    public static boolean varbitChecks(Transport transport) {
        return transport.getVarbits().isEmpty()
                ...
                .allMatch(varbitCheck -> varbitCheck.matches(CupidBot.getVarbitValue(varbitCheck.getVarbitId())));
    }
    ...
    public static boolean varplayerChecks(Transport transport) {
        return transport.getVarplayers().isEmpty()
                ...
                .allMatch(varplayerCheck -> varplayerCheck.matches(CupidBot.getVarbitPlayerValue(varplayerCheck.getVarplayerId())));
    }
}
