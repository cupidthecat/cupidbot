...
public class Global {
    ...
    public static void sleep(int start) {
        if (CupidBot.getClient().isClientThread()) return;
        try {
            Thread.sleep(start);
    ...
    public static <T> T sleepUntilNotNull(Callable<T> method, int timeoutMillis, int sleepMillis) {
        if (CupidBot.getClient().isClientThread()) return null;
        boolean done;
        T methodResponse;
    ...
    public static boolean sleepUntil(BooleanSupplier awaitedCondition, int time) {
        if (CupidBot.getClient().isClientThread()) return false;
        ...
        try {
            ...
            CupidBot.logStackTrace("Global Sleep: ", e);
        }
        return false;
    }
    ...
    public static void sleepUntilOnClientThread(BooleanSupplier awaitedCondition, int time) {
        ...
        try {
            do {
                ...
                done = CupidBot.getClientThread().runOnClientThreadOptional(awaitedCondition::getAsBoolean).orElse(false);
    ...
    public static boolean sleepUntilNextTick() {
        if (CupidBot.getClient().isClientThread()) return false;
        GameTickBroadcaster broadcaster = CupidBot.getGameTickBroadcaster();
