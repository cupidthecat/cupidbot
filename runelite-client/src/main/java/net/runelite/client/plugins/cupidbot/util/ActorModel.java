...
public class ActorModel implements Actor
{
	...
	public LocalPoint getCameraFocus() {
		return CupidBot.getClientThread().runOnClientThreadOptional(actor::getCameraFocus).orElse(null);
	}

	@Override
	public int getCombatLevel()
	{
		return CupidBot.getClientThread().runOnClientThreadOptional(actor::getCombatLevel).orElse(0);
	}

    @Override
	public @Nullable String getName()
	{
		return CupidBot.getClientThread().runOnClientThreadOptional(actor::getName).orElse(null);
	}
	...
	{
		return CupidBot.getClientThread().runOnClientThreadOptional(actor::getInteracting).orElse(null);
	}

	@Override
	public int getHealthRatio()
	{
		return CupidBot.getClientThread().runOnClientThreadOptional(actor::getHealthRatio).orElse(0);
	}

	@Override
	public int getHealthScale()
	{
		return CupidBot.getClientThread().runOnClientThreadOptional(actor::getHealthScale).orElse(0);
	}

	@Override
	public WorldPoint getWorldLocation()
	{
		return CupidBot.getClientThread().invoke(actor::getWorldLocation);
	}

	@Override
	public LocalPoint getLocalLocation()
	{
		return CupidBot.getClientThread().invoke(actor::getLocalLocation);
	}
	...
	{
		return CupidBot.getClientThread().invoke(actor::getWorldArea);
	}
