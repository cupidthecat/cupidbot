...
public class Rs2ObjectModel {
    ...
    public Rs2ObjectModel(TileObject tileObject, Tile tile) {
        ...
        this.creationTick = CupidBot.getClient().getTickCount();
    }
    ...
    public int getTicksSinceCreation() {
        return CupidBot.getClientThread().runOnClientThreadOptional(() ->
            CupidBot.getClient().getTickCount() - creationTick).orElse(0);
    }
    ...
    public ObjectComposition getObjectComposition() {
        if (this.objectComposition == null){
            this.objectComposition =  CupidBot.getClientThread().runOnClientThreadOptional(() ->
            CupidBot.getClient().getObjectDefinition(tileObject.getId())
            ).orElse(null);
        }
