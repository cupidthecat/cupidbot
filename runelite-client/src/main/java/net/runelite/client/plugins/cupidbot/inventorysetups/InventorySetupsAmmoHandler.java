package net.runelite.client.plugins.cupidbot.inventorysetups;

import net.runelite.client.plugins.cupidbot.inventorysetups.ui.InventorySetupsPluginPanel;
import net.runelite.client.plugins.cupidbot.inventorysetups.ui.InventorySetupsRunePouchPanel;
import net.runelite.client.plugins.cupidbot.inventorysetups.ui.InventorySetupsSlot;
...
import static net.runelite.client.plugins.cupidbot.inventorysetups.ui.InventorySetupsBoltPouchPanel.BOLT_POUCH_AMOUNT_VARBIT_IDS;
import static net.runelite.client.plugins.cupidbot.inventorysetups.ui.InventorySetupsBoltPouchPanel.BOLT_POUCH_BOLT_VARBIT_IDS;
import static net.runelite.client.plugins.cupidbot.inventorysetups.ui.InventorySetupsQuiverPanel.DIZANA_QUIVER_IDS;
import static net.runelite.client.plugins.cupidbot.inventorysetups.ui.InventorySetupsQuiverPanel.DIZANA_QUIVER_IDS_SET;
import static net.runelite.client.plugins.cupidbot.inventorysetups.ui.InventorySetupsRunePouchPanel.RUNE_POUCH_AMOUNT_VARBITS;
import static net.runelite.client.plugins.cupidbot.inventorysetups.ui.InventorySetupsRunePouchPanel.RUNE_POUCH_DIVINE_IDS_SET;
import static net.runelite.client.plugins.cupidbot.inventorysetups.ui.InventorySetupsRunePouchPanel.RUNE_POUCH_IDS_SET;
import static net.runelite.client.plugins.cupidbot.inventorysetups.ui.InventorySetupsRunePouchPanel.RUNE_POUCH_RUNE_VARBITS;
