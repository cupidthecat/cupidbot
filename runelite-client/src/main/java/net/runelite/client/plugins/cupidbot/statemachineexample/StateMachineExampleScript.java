package net.runelite.client.plugins.cupidbot.statemachineexample;
...
import net.runelite.client.plugins.cupidbot.statemachine.StateMachineScript;
import net.runelite.client.plugins.cupidbot.statemachine.Transition;
...
public class StateMachineExampleScript extends StateMachineScript<StateMachineExampleScript.State> {
    ...
    private void doScanNpcs() {
        ...
        List<Rs2NpcModel> npcs = CupidBot.getRs2NpcCache().query()
                .within(15)
                .toList();
        ...
        Rs2NpcModel nearest = CupidBot.getRs2NpcCache().query()
                .within(15)
                .nearest();
    ...
    private void doScanObjects() {
        ...
        List<Rs2TileObjectModel> objects = CupidBot.getRs2TileObjectCache().query()
                .within(10)
                .toList();
        ...
        Rs2TileObjectModel nearest = CupidBot.getRs2TileObjectCache().query()
    ...
    private void doScanGroundItems() {
        ...
        List<Rs2TileItemModel> items = CupidBot.getRs2TileItemCache().query()
                .within(15)
                .toList();
        ...
        Rs2TileItemModel nearest = CupidBot.getRs2TileItemCache().query()
