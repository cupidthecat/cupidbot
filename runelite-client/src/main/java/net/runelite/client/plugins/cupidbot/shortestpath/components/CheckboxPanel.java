...
import net.runelite.client.plugins.cupidbot.shortestpath.ShortestPathConfig;
import net.runelite.client.plugins.cupidbot.util.poh.PohTeleports;
import net.runelite.client.plugins.cupidbot.util.poh.data.*;
...
import static net.runelite.client.plugins.cupidbot.shortestpath.ShortestPathPlugin.CONFIG_GROUP;

public class CheckboxPanel extends JPanel {
    private static final Logger log = LoggerFactory.getLogger(CheckboxPanel.class);
    ...
    private void setBool(String key, boolean value) {
        CupidBot.getConfigManager().setConfiguration(CONFIG_GROUP, key, value);
    }

    private boolean getBool(String key) {
        try {
            return CupidBot.getConfigManager().getConfiguration(CONFIG_GROUP, key, Boolean.class);
        } catch (NullPointerException e) {
            log.debug("PoH checkbox config not set for {}; using false.", key);
            return false;
        }
    }
