package net.runelite.client.plugins.cupidbot.util.widget;
...
public class Rs2Widget {
    ...
    public static Widget getWidget(@Component int id) {
        return CupidBot.getClientThread().runOnClientThreadOptional(() -> CupidBot.getClient().getWidget(id)).orElse(null);
    }

    public static boolean isHidden(int parentId, int childId) {
        return CupidBot.getClientThread().runOnClientThreadOptional(() -> {
            Widget widget = CupidBot.getClient().getWidget(parentId, childId);
    ...
    public static boolean isHidden(@Component int id) {
        return CupidBot.getClientThread().runOnClientThreadOptional(() -> {
            Widget widget = CupidBot.getClient().getWidget(id);
            if (widget == null) return true;
            return widget.isHidden();
        }).orElse(false);
    }
    ...
    public static Widget getWidget(int id, int child) {
        return CupidBot.getClientThread().runOnClientThreadOptional(() -> CupidBot.getClient().getWidget(id, child))
                .orElse(null);
    }

    public static int getChildWidgetSpriteID(int id, int childId) {
        return CupidBot.getClientThread().runOnClientThreadOptional(() -> {
            Widget w = CupidBot.getClient().getWidget(id, childId);
            if (w == null) return -1;
    ...
    public static boolean clickWidget(int id) {
        Widget widget = CupidBot.getClientThread().runOnClientThreadOptional(() -> CupidBot.getClient().getWidget(id)).orElse(null);;
    ...
    public static boolean clickChildWidget(int id, int childId) {
        ...
        CupidBot.getMouse().click(child.getBounds());
        return true;
    }
    ...
    public static Widget findWidget(String text, List<Widget> children, boolean exact) {
        return CupidBot.getClientThread().runOnClientThreadOptional(() -> {
            ...
            if (children == null) {
                ...
                List<Widget> rootWidgets = Arrays.stream(CupidBot.getClient().getWidgetRoots())
    ...
    public static boolean enterWilderness() {
        ...
        CupidBot.log("Detected Wilderness warning, interacting...");
    ...
    public static boolean waitForWidget(String text, int timeout) {
        return sleepUntil(() -> CupidBot.getClientThread().runOnClientThreadOptional(() -> hasVisibleWidgetText(text)).orElse(false), timeout);
    }
