...
public class InputSelector {
    ...
    static {
        ENABLED_IMAGE = ImageUtil.loadImageResource(CupidBot.class, "enabled_small.png");
        DISABLED_IMAGE = ImageUtil.loadImageResource(CupidBot.class, "disabled_small.png");
    }
    ...
    public void enableClick() {
        ...
        CupidBot.getClient().getCanvas().setFocusable(true);
        addAndRemoveButtons();
    }

    public void disableClick() {
        ClientUI.getClient().setEnabled(false);
        CupidBot.getClient().getCanvas().setFocusable(false);
        addAndRemoveButtons();
    }
}
