...
public class BlockingEventManager
{
    ...
    private final ThreadFactory threadFactory = runnable -> {
        Thread t = new Thread(runnable, "CupidBot-BlockingEvent");
        t.setDaemon(true);
        return t;
    };
     ...
     * Called from {@link net.runelite.client.plugins.cupidbot.Script#run()} to pause script loops until blockers finish.
     */
