package net.runelite.client.plugins.cupidbot.util.skills.slayer;
...
import net.runelite.client.plugins.cupidbot.util.npc.MonsterLocation;
import net.runelite.client.plugins.cupidbot.util.npc.Rs2NpcManager;
import net.runelite.client.plugins.cupidbot.util.skills.slayer.enums.ProtectiveEquipment;
import net.runelite.client.plugins.cupidbot.util.skills.slayer.enums.SlayerMaster;
...
public class Rs2Slayer {
    ...
    public static int getSlayerTaskSize() {
        return CupidBot.getVarbitPlayerValue(VarPlayerID.SLAYER_COUNT);
    }
    ...
    public static String getSlayerTask() {
        int taskId = CupidBot.getVarbitPlayerValue(VarPlayerID.SLAYER_TARGET);
        if (taskId == 0) {
            return null;
        }
        ...
        {
            var bossRows = CupidBot.getDBRowsByValue(
            ...
            taskDBRow = (Integer) CupidBot.getDBTableField(
                    bossRows.get(0),
                    DBTableID.SlayerTaskSublist.COL_TASK, 0)[0];
        }
        else
        {
            var taskRows = CupidBot.getDBRowsByValue(
        ...
        return (String) CupidBot.getDBTableField(
                taskDBRow,
    ...
    public static MonsterLocation getSlayerTaskLocation(int minClustering, boolean avoidWilderness) {
        ...
        if (names == null || names.isEmpty()) {
            CupidBot.log(Level.DEBUG,"No Slayer task found or no monsters available for the task.");
            return null;
        }
     ...
     * and then the name of the item using the CupidBot getItemManager to fetch the item composition.
     *
    ...
    public static String getSlayerTaskWeaknessName() {
        ...
        return CupidBot.getClientThread().runOnClientThreadOptional(() -> CupidBot.getClient().getItemDefinition(itemId).getName()).orElse("");
    }
    ...
    public static List<Transport> prepareItemTransports(WorldPoint cachedMonsterLocation) {
        ...
        transports
                .forEach(t -> CupidBot.log(Level.DEBUG,"Item required: " + t));
