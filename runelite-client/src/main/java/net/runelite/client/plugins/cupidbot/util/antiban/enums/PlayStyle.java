...
public enum PlayStyle {
    ...
    public void evolvePlayStyle() {
        ...
        if(Rs2AntibanSettings.devDebug)
            CupidBot.log("Slightly adjusting playStyle intervals.");
    }
    ...
    public PlayStyle switchProfile() {
        ...
        if (refocus) {
            ...
            if(Rs2AntibanSettings.devDebug)
                CupidBot.log("Refocusing, switching to: " + newProfile.getName());
            return newProfile;
        }
        ...
        if(Rs2AntibanSettings.devDebug)
            CupidBot.log("Switched profile to: " + newProfile.getName());
        return newProfile;
    }
