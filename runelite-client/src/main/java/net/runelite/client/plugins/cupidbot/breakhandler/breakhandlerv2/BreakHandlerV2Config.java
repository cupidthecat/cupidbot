...
import net.runelite.client.plugins.cupidbot.util.antiban.enums.PlaySchedule;
import net.runelite.client.plugins.cupidbot.util.world.RegionPreference;
import net.runelite.client.plugins.cupidbot.util.world.WorldSelectionMode;
...
public interface BreakHandlerV2Config extends Config {
    ...
    @ConfigItem(
        ...
        description = "Select a CupidBot or Plugin Hub plugin to stop automatically when a break begins.",
        position = 2,
        section = breakBehaviorOptions
    )
