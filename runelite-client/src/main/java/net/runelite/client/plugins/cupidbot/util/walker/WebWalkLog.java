...
public final class WebWalkLog {
    ...
    /** Pathfinder {@link net.runelite.client.plugins.cupidbot.shortestpath.pathfinder.Pathfinder} — DEBUG volume. */
    public static void pf(String fmt, Object... args) {
        LOG.debug("[WebWalk] pf | " + fmt, args);
    }

    /** {@link net.runelite.client.plugins.cupidbot.shortestpath.pathfinder.PathfinderConfig} refresh — DEBUG volume. */
