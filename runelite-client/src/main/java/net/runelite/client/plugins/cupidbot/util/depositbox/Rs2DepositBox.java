package net.runelite.client.plugins.cupidbot.util.depositbox;
...
import net.runelite.client.plugins.cupidbot.util.gameobject.Rs2BankID;
...
public class Rs2DepositBox {
    ...
    public static boolean openDepositBox() {
        CupidBot.status = "Opening deposit box";
        try {
            ...
            CupidBot.log("Error opening deposit box: " + e.getMessage());
        }
        return false;
    }
    ...
    public static void depositAll() {
        CupidBot.status = "Depositing all items";
    ...
    public static DepositBoxLocation getNearestDepositBox(WorldPoint worldPoint, int maxObjectSearchRadius) {
        CupidBot.log("Finding nearest deposit box...");
        ...
        if (accessibleDepositBoxes.isEmpty()) {
            CupidBot.log("No accessible deposit boxes found");
            return null;
        }
        ...
        if (Objects.equals(Rs2Player.getWorldLocation(), worldPoint)) {
            ...
            if (byObject.isPresent()) {
                CupidBot.log("Found nearest deposit box (object): " + byObject.get());
                return byObject.get();
            }
        }
        ...
        if (path.isEmpty()) {
            CupidBot.log("Unable to find path to any deposit box");
            return null;
        }
        ...
        if (byPath.isPresent()) {
            CupidBot.log("Found nearest deposit box (shortest path): " + byPath.get());
            return byPath.get();
        }

        CupidBot.log("Nearest deposit box point " + nearestTile + " did not match any DepositBoxLocation");
        return null;
    }
    ...
    public static boolean walkToDepositBox(DepositBoxLocation depositBoxLocation) {
        ...
        CupidBot.status = "Walking to nearest deposit box " + depositBoxLocation.name();
