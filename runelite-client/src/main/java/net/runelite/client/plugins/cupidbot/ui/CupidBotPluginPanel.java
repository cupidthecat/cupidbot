...
public abstract class CupidBotPluginPanel extends JPanel implements Activatable
{
    ...
    protected CupidBotPluginPanel()
    {
        this(true);
    }

    protected CupidBotPluginPanel(boolean wrap)
    {
        super();
        if (wrap)
        {
