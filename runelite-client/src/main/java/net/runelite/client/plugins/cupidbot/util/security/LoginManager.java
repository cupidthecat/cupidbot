...
public final class LoginManager {
    ...
    public static ConfigProfile getActiveProfile() {
        return CupidBot.getConfigManager().getProfile();
	}
	...
	/**
	 * Returns the duration the account has been logged in for. Equivalent to CupidBot.getLoginTime().
	 */
    ...
    public static boolean login() {
        ...
        if (selectedWorld != null) {
            ...
            if (getActiveProfile().isMember() && !isCurrentWorldMembers() ||
                ...
                targetWorld = CupidBot.getClient().getWorld();
            }
    ...
    private static void handleDisconnectDialogs(Client client) {
        ...
        if (loginIndex == 3 || loginIndex == 24 || loginIndex == 34 || loginIndex == 4 || loginIndex == 14) {
            ...
            CupidBot.getMouse().click(365 + startingWidth, 308);
            sleep(600);
        }
    }
    ...
    private static void handleBlockingDialogs(Client client) {
        ...
        if (loginIndex == 10) {
            CupidBot.getMouse().click(365 + startingWidth, 250);
        } else if (loginIndex == 9) {
            CupidBot.getMouse().click(365 + startingWidth, 300);
        }
    }
    ...
    public static int getRandomWorld(boolean isMembers, WorldRegion region) {
        ...
        if (CupidBot.getClient() != null && CupidBot.getClient().getWorldType() != null) {
            isInSeasonalWorld = CupidBot.getClient().getWorldType().contains(net.runelite.api.WorldType.SEASONAL);
        } else {
    ...
    public static int getNextWorld(boolean isMembers, WorldRegion region) {
        ...
        int currentWorldId = CupidBot.getClient() != null ? CupidBot.getClient().getWorld() : -1;
        int currentIndex = -1;
    ...
    public static boolean isMemberWorld(int worldId) {
        ...
        if (CupidBot.getWorldService() == null) {
            return false;
        }
        try {
    ...
    public static void setWorld(int worldNumber) {
        try {
            if (CupidBot.getWorldService() == null || CupidBot.getClient() == null) {
