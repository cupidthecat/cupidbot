...
@Singleton
public class CupidBotTopLevelConfigPanel extends PluginPanel {
    ...
    private CupidBotPluginPanel current;
    ...
    @Inject
    CupidBotTopLevelConfigPanel(
            EventBus eventBus,
            CupidBotPluginListPanel pluginListPanel,
            CupidBotProfilePanel profilePanel,
        ...
        pluginListPanelTab = addTab(pluginListPanel.getMuxer(), installedIcon, "Installed CupidBot Plugins");
        profilePanelTab = addTab(profilePanel, "profile_icon.png", "Profiles");
        addTab(cupidbotPluginHubPanelProvider, hubIcon, "CupidBot Hub");
    ...
    private JPanel buildVersionFooter() {
        ...
        String version = RuneLiteProperties.getCupidBotVersion();
        JLabel versionLabel = new JLabel(version == null || version.isBlank() ? "cupidbot" : "cupidbot v" + version, SwingConstants.CENTER);
    ...
    private MaterialTab addTab(CupidBotPluginPanel panel, ImageIcon icon, String tooltip) {
    ...
    private MaterialTab addTab(CupidBotPluginPanel panel, String image, String tooltip)
    {
    ...
    private MaterialTab addTab(Provider<? extends CupidBotPluginPanel> panelProvider, ImageIcon icon, String tooltip) {
        MaterialTab mt = new MaterialTab(icon, tabGroup, null);
        mt.setToolTipText(tooltip);
        tabGroup.addTab(mt);
        ...
        mt.setOnSelectEvent(() ->
        {
            CupidBotPluginPanel panel = panelProvider.get();
    ...
    private void switchTo(String cardName, CupidBotPluginPanel panel, boolean removeOnTabChange) {
        boolean doRemove = this.removeOnTabChange;
        CupidBotPluginPanel prevPanel = current;
        if (active) {
