 ...
 *
 * IMPORTANT: Always use CupidBot.getRs2TileObjectCache().query() to create queries.
 * Never instantiate Rs2TileObjectQueryable directly.
 *
 * - Rs2TileObjectCache: Singleton cache accessed via CupidBot.getRs2TileObjectCache()
 * - query(): Returns a fluent queryable interface for filtering tile objects
 */
public class TileObjectApiExample {

    public static void examples() {
        Rs2TileObjectCache cache = CupidBot.getRs2TileObjectCache();
