...
public class Rs2Antiban {
    ...
    private static void logDebug(String message) {
        if (Rs2AntibanSettings.devDebug) {
            CupidBot.log("<col=f44336>" + message + "</col>");
        }
    }
    ...
    public static void moveMouseOffScreen() {
        ...
        CupidBot.naturalMouse.moveOffScreen(100.0); // Calls the overloaded method with a 100% chance
    }
    ...
    public static void moveMouseOffScreen(double chance) {
        CupidBot.naturalMouse.moveOffScreen(chance);
    }
    ...
    public static void moveMouseRandomly() {
        CupidBot.naturalMouse.moveRandom();
    }
