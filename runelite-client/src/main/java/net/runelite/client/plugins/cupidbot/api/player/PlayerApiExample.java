 ...
 *
 * IMPORTANT: Always use CupidBot.getRs2PlayerCache().query() to create queries.
 * Never instantiate Rs2PlayerQueryable directly.
 *
 * - Rs2PlayerCache: Singleton cache accessed via CupidBot.getRs2PlayerCache()
 * - query(): Returns a fluent queryable interface for filtering players
 */
public class PlayerApiExample {

    public static void examples() {
        Rs2PlayerCache cache = CupidBot.getRs2PlayerCache();
