package net.runelite.client.plugins.cupidbot.util.magic.thralls;
...
import net.runelite.client.plugins.cupidbot.util.magic.Spell;
...
public enum Rs2Thrall implements Spell
{
	...
	{
		return (CupidBot.getVarbitValue(VarbitID.ARCEUUS_RESURRECTION_ACTIVE) == 1 || CupidBot.getVarbitValue(VarbitID.ARCEUUS_RESURRECTION_COOLDOWN) >= 1);
	}
