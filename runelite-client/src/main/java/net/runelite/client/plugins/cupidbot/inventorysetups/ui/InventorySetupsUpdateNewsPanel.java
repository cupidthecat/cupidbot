...
import static net.runelite.client.plugins.cupidbot.inventorysetups.MInventorySetupsPlugin.SUGGESTION_LINK;
import static net.runelite.client.plugins.cupidbot.inventorysetups.MInventorySetupsPlugin.TUTORIAL_LINK;
