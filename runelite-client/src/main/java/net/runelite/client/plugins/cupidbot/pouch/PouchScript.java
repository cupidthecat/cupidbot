package net.runelite.client.plugins.cupidbot.pouch;
...
public class PouchScript extends Script {
        ...
        if (!checkedPouches.isEmpty()) {
            ...
            if (matcher.matches()) {
                ...
                do {
                    ...
                    if (op.tick >= CupidBot.getClient().getTickCount()) {
    ...
    public void onItemContainerChanged(ItemContainerChanged event) {
        ...
        final int tick = CupidBot.getClient().getTickCount();
    ...
    public void onMenuOptionClicked(MenuOptionClicked event) {
        ...
        final int tick = CupidBot.getClient().getTickCount() + 3;
