package net.runelite.client.plugins.cupidbot.util.shop;
...
import static net.runelite.client.plugins.cupidbot.CupidBot.updateItemContainer;
import static net.runelite.client.plugins.cupidbot.util.Global.sleepUntil;
import static net.runelite.client.plugins.cupidbot.util.Global.sleepUntilOnClientThread;
...
public class Rs2Shop {
    ...
    public static boolean openShop(String npcName, boolean exact) {
        ...
        try {
            ...
            CupidBot.logStackTrace("Rs2Shop", ex);
        }
        return false;
    }
    ...
    public static boolean buyItem(String itemName, String quantity) {
        CupidBot.status = "Buying " + quantity + " " + itemName;
        try {
    ...
    public static boolean buyItem(int itemId, String quantity) {
        CupidBot.status = "Buying " + quantity + " item with ID " + itemId;
        try {
            Rs2ItemModel rs2Item = shopItems.stream()
