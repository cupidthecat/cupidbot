...
public class SettingsHandler extends AgentHandler {
	...
	private static final Map<String, String> VALID_CONFIG_KEYS = Map.of(
		"disableLevelUpInterface", CupidBotConfig.keyDisableLevelUpInterface,
		"disableWorldSwitcherConfirmation", CupidBotConfig.keyDisableWorldSwitcherConfirmation
	);
	...
	private void handleConfig(HttpExchange exchange) throws IOException {
		...
		configManager.setConfiguration(CupidBotConfig.configGroup, configKey, value.toString());
