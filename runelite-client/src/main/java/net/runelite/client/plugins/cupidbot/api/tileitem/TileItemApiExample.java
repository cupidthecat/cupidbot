 ...
 *
 * IMPORTANT: Always use CupidBot.getRs2TileItemCache().query() to create queries.
 * Never instantiate Rs2TileItemQueryable directly.
 *
 * - Rs2TileItemCache: Singleton cache accessed via CupidBot.getRs2TileItemCache()
 * - query(): Returns a fluent queryable interface for filtering ground items
 */
public class TileItemApiExample {

    public void examples() {
        Rs2TileItemCache cache = CupidBot.getRs2TileItemCache();
