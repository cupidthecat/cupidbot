    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            if (config.showDetailedInfo()) {
                ...
                String stopDisplay = PluginStopHelper.resolveDisplayName(stopConfigValue, CupidBot.getPluginManager());
                boolean hasStopTarget = !PluginStopHelper.isNone(PluginStopHelper.normalizeStoredValue(stopConfigValue, CupidBot.getPluginManager()));
                ...
                if (CupidBot.isLoggedIn()) {
                    int currentWorld = CupidBot.getClient().getWorld();
                    panelComponent.getChildren().add(LineComponent.builder()
                        .left("Current world:")
